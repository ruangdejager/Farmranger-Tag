...
#define STRUCT_VAL_byte(MemOffset, FieldName) ((MemOffset->FieldName))
#define STRUCT_VAL_word(MemOffset, FieldName) ((MemOffset->FieldName))
#define STRUCT_VAL_dword(MemOffset, FieldName) ((MemOffset->FieldName))
